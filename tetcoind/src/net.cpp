...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Tetcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"tetcoin.com", "dnsseed.tetcoin.com"},
    {"tetcoin.org", "dnsseed.tetcoin.org"},
    /**{"xurious.com", "dnsseed.TET.xurious.com"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"tetcoin.com", "testnet-seed.tetcoin.com"},
    {"tetcoin.org", "testnet-seed.tetcoin.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Tetcoin is probably already running."), addrBind.ToString().c_str());
        else
