...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 8899 or testnet: 18899)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Tetcoin Wiki for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Tetcoin is probably already running."), strDataDir.c_str()));
